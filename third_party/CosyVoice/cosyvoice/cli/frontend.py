    ...
    def __init__(self,
        ...
        try:
            ...
            try:
                ...
                WETEXT_DIR = '{}/../../../../models/wetext'.format(os.path.dirname(os.path.abspath(__file__)))
                self.zh_tn_model = ZhNormalizer(tagger_path='{}/zh/tn/tagger.fst'.format(WETEXT_DIR), verbalizer_path='{}/zh/tn/verbalizer.fst'.format(WETEXT_DIR), remove_erhua=False, lang='zh')
                self.en_tn_model = EnNormalizer(tagger_path='{}/en/tn/tagger.fst'.format(WETEXT_DIR), verbalizer_path='{}/en/tn/verbalizer.fst'.format(WETEXT_DIR), lang='en')
